...
const KidsAuth = ({setSlideAvailable, setSlideUnAvailable}) => {
    ...
    return (
      <div className="flex  justify-between flex-col px-6 pt-8 pb-4">
        <form className="flex w-full flex-col gap-4">
            <RadioGroup value={selected} onValueChange={setSelected} description="Selected plan can be changed at any time." label="Kids:">
                {KidStatus.map((value)=> {
